                        ...
                        <tbody class="divide-y divide-gray-50">
                            @forelse ($rankings as $ranking)
                                <tr class="hover:bg-gray-50/60 transition-colors">
                                    ...
                                    <td class="px-5 py-4">
                                        <p class="font-black text-gray-950">{{ $ranking->participant?->displayName() ?? $ranking->user?->name ?? $ranking->participant?->user?->name }}</p>
                                    </td>
                                    <td class="hidden px-5 py-4 text-gray-500 sm:table-cell">
                                        {{ $ranking->user?->name ?? $ranking->participant?->user?->name }}
                                    </td>
